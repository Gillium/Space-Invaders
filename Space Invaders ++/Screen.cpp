...
void Screen::addPanel(unique_ptr<UIPanel> uip, ScreenManagerRemoteControl* smcr, shared_ptr<InputHandler> ih)
{
	ih->initialiseInputHandler(smcr, uip->getButtons(), &uip->m_View, this);
